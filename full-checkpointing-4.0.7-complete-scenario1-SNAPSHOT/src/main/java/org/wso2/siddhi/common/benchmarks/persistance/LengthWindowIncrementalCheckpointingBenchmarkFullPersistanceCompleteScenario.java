...
/**
 * The benchmark for full checkpointing persistance.
 */
public class LengthWindowIncrementalCheckpointingBenchmarkFullPersistanceCompleteScenario {
    private static final Logger log = Logger.getLogger(
            LengthWindowIncrementalCheckpointingBenchmarkFullPersistanceCompleteScenario.class);
    ...
    public static class ApplicationState {
        ...
        public void doTearDown() {
            try {
                log.info("----- Length Batch Window Full Checkpoint Benchmark - Complete Scenario -----");
